...
// ```
//
// # Query report, Aggregation funcions
//
// ```
//
//	res5, err := tb.SelectAll(&xdominion.XFieldSet{"f1", "count(*)"}, &xdominion.XConditions{xdominion.NewXCondition("f1", "!=", 1)}, &xdominion.XGroupBy{"f1"}, &xdominion.XOrderBy{"count(*)", xdominion.DESC}, 10)
//	if err != nil {
//	  fmt.Println(err)
//	} else {
//	  switch res5.(type) {
